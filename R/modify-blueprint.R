...
.modify_blueprint_sys_prompt <- function() {
  ...
  prompt <- paste(
    ...
    "\n",
    "After receiving the user's answer, the conversation continues and you can ask another question or return the modified blueprint when ready.",
    ...
    "\n",
    "Example flow:",
    "1. {\"question\": \"Do you want to add batch correction?\"}",
    "2. (User answers \"yes\")",
    "3. {\"question\": \"What is the batch column?\"}",
    "4. (User answers \"batch_col\")",
    "5. {\"explanation\": \"Added batch correction.\", \"steps\": [...]}",
