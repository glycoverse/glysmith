...
.inquire_blueprint_sys_prompt <- function() {
  ...
  prompt <- paste(
    ...
    "Ask ONE question at a time. Return a JSON object with a single `question` field:",
    ...
    "2. (User answers \"yes\")",
    "3. {\"question\": \"What is the column name for batch information?\"}",
    "4. (User answers \"batch_id\")",
    "5. {\"explanation\": \"Preprocess with batch correction.\", \"steps\": [...]}",
    "\n",
