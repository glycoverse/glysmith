...
.inquire_blueprint_sys_prompt <- function() {
  ...
  prompt <- paste(
    ...
    "You need to ask at least 5 questions to understand the user's request.",
    ...
    "An atomic question has ONE concept and ONE answer.",
    ...
    "Return a JSON object with a single `question` field: {\"question\": \"Your question here\"}",
    "\n",
    "Example flow:",
    "1. {\"question\": \"Do you want to perform preprocessing?\"}",
    "2. (User answers \"yes\")",
    "3. {\"question\": \"Do you have batch information?\"}",
    "4. (User answers \"yes\")",
    "5. {\"question\": \"What is the column name for batch information?\"}",
    "6. (User answers \"batch_id\")",
    "7. {\"explanation\": \"Preprocess with batch correction.\", \"steps\": [...]}",
    "\n",
    ...
    "",
    "Example output 3 (Single question):",
    "{\"question\":\"What is your group column?\"}",
    sep = "\n"
  )
  prompt
}
