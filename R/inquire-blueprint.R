...
.inquire_blueprint_sys_prompt <- function() {
  ...
  prompt <- paste(
    ...
    "If essential information is missing (e.g., required arguments, or the user's intention is not clear),",
    "ask the user for clarification instead of guessing.",
    "Feel free to ask follow-up questions to better understand the analysis goals, data characteristics, or specific requirements.",
    "Provide a few options when possible to help the user choose.",
