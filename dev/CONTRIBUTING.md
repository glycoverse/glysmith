...
This outlines how to propose a change to glysmith. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glysmith", fork = TRUE)`.
...
Please note that the glysmith project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glysmith/dev/CODE_OF_CONDUCT.md).
