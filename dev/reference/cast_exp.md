...
#>   hist.boot    FSA 
#>   confint.boot FSA 
#> ✔ Principal component analysis [312ms]
#> 
...
#> ℹ Differential expression analysis (limma)
#> ✔ Differential expression analysis (limma) [82ms]
#> 
#> ℹ Volcano plot
#> ✔ Volcano plot [552ms]
#> 
#> ℹ Heatmap of significant variables
#> ✔ Heatmap of significant variables [90ms]
#> 
...
#> ✔ Derived trait calculation [8.6s]
#> 
