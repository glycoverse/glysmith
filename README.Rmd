...
[![R-universe version](https://glycoverse.r-universe.dev/glysmith/badges/version)](https://glycoverse.r-universe.dev/glysmith)
...
The glysmith package is not a core glycoverse package.
...
You can install the latest release of glysmith from [r-universe](https://glycoverse.r-universe.dev/glysmith) (**recommended**):
...
After installing `glysmith`, you also need to install additional dependencies to use this package:
