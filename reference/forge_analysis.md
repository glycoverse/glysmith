...
#> ✔ Principal component analysis [469ms]
#> 
...
#> ℹ Differential expression analysis (limma)
#> ✔ Differential expression analysis (limma) [99ms]
#> 
#> ℹ Volcano plot
#> ✔ Volcano plot [511ms]
#> 
#> ℹ Heatmap of significant variables
#> ✔ Heatmap of significant variables [70ms]
#> 
...
#> ✔ Heatmap of significant traits [98ms]
#> 
print(result)
#> 
