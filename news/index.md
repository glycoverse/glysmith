...
- [`polish_report()`](https://glycoverse.github.io/glysmith/reference/polish_report.md)
  with `use_ai = TRUE` now includes a summary of the analysis results at
  the end of the report, generated by the LLM using multimodal reasoning
  (#16).

### Minor improvements and bug fixes

- [`check_glysmith_deps()`](https://glycoverse.github.io/glysmith/reference/check_glysmith_deps.md)
  now checks only the packages required by the supplied blueprint,
  instead of asking users to install every optional dependency.
  Step-specific glycoverse packages are optional again, with
  installation guidance for the glycoverse r-universe repository (#17).
...
- [`quench_result()`](https://glycoverse.github.io/glysmith/reference/quench_result.md)
  no longer leaves a stray `Rplots.pdf` in the working directory (#18).
