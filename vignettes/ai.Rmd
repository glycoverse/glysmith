...
By providing a `GlycomicSE` or `GlycoproteomicSE` object as `exp`, the LLM can
understand your data structure and experimental design,
...
You can then pass it to `forge_analysis()`:
